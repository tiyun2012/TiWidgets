param(
    ...
    [ValidateSet("baseline", "splitter_stress", "widget_drag_stress", "mixed", "resize_stress", "resize_crash_stress", "recursive_constraints_stress", "close_all", "global_float_sync", "host_transfer_stress", "ui_workspace", "native_repaint", "tab_drag")]
...
$env:DF_THEME = $Theme
if ($Scenario -in @('native_repaint', 'tab_drag')) { $env:DF_NATIVE_FLOAT_HOSTS = '1' }
